...
export default function Dashboard() {
  ...
  useEffect(() => {
    async function load(initial = false) {
      ...
      const totalProfit = allDispatchProfitTotal + allSaleProfitTotal + allChozaProfitTotal
    ...
    // adding a payment, etc. on another page is reflected without a manual refresh.
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Profit breakdown modal — categorise profit by product type. */}
      {profitModal.open && (() => {
        const TYPE_META = {
