...
-- Fix: allow meel + choza types in products (migration if table already exists)
...
-- Localized name variants for bilingual display (Dari = _fa, Pashto = _ps).
-- Required by the app's joins, e.g. farms(name, name_fa, name_ps).
...
-- ============================================================
-- RLS POLICIES: Supabase keeps RLS ENABLED on API-exposed tables,
-- so 'disable row level security' above is not enough — the anon key
-- still gets blocked. Ensure every table has a permissive policy.
-- ============================================================
alter table products enable row level security;
...
-- ============================================================
-- Schema drift: farm_batches + market_seller_payments + batch_id cols
-- ============================================================
...
-- ============================================================
-- Store cash drawer (cash on hand)
-- ============================================================
